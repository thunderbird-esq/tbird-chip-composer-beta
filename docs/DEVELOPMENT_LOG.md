...
## [2025-06-19] Feature expansion
- Added inline editing for all grid columns.
- Implemented basic tracker effects (slide, arpeggio).
- Instruments now support filter cutoff and LFO with UI controls.
